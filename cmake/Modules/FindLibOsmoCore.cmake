if(NOT LIBOSMOCORE_FOUND)
  ...
  find_path(LIBOSMOCORE_INCLUDE_DIR NAMES osmocom/core/gsmtap.h
    PATHS
...
if(LIBOSMOCORE_INCLUDE_DIR AND LIBOSMOCORE_LIBRARIES)
...
else(LIBOSMOCORE_INCLUDE_DIR AND LIBOSMOCORE_LIBRARIES)
  set(LIBOSMOCORE_FOUND FALSE CACHE INTERNAL "libosmocore found")
  message(STATUS "libosmocore not found.")
endif(LIBOSMOCORE_INCLUDE_DIR AND LIBOSMOCORE_LIBRARIES)

mark_as_advanced(LIBOSMOCORE_INCLUDE_DIR LIBOSMOCORE_LIBRARIES)
